...
// A set of files, or a single file, that should be treated as binaries and symlinked into
// bin-dir (from config).
type Bin struct {
	String      *string
	StringArray []string
...
func (x *Bin) UnmarshalJSON(data []byte) error {
	x.StringArray = nil
...
func (x *Bin) MarshalJSON() ([]byte, error) {
